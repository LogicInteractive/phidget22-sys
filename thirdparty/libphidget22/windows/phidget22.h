...
typedef enum {
	...
	PHIDID_MESHHUB = 0x41,	/* Phidget Mesh Hub with 4 ports */
	PHIDID_MESHDONGLE = 0x42,	/* Phidget Mesh Dongle */
	PHIDID_HUB0004 = 0x43,	/* Phidget SPI VINT Hub with 6 ports */
	PHIDID_LIGHTNINGHUB = 0x44,	/* Phidget Lightning VINT Hub with 6 ports */
	...
	PHIDID_MOT0108 = 0x83,	/* PhidgetSpatial 3/3/3 */
	PHIDID_ADP1001 = 0x84,	/* RS232 Adapter */
	...
	PHIDID_VINTACCEL = 0x8a,	/* VINT Accelerometer */
	PHIDID_TP_DIAGNOSER = 0x8b,	/* Testpoint Diagnoser */
	PHIDID_MOT0109 = 0x8c,	/* PhidgetSpatial Precision 3/3/3 */
	PHIDID_MOT0110 = 0x8d,	/* PhidgetSpatial Precision 3/3/3 */
	...
	PHIDID_DAQ0501 = 0x90,	/* PhidgetBridge 4-Input (DAQ0501) */
} Phidget_DeviceID;
...
__declspec(dllimport) PhidgetReturnCode __stdcall Phidget_getDataRate				(PhidgetHandle phid, double *dr);
__declspec(dllimport) PhidgetReturnCode __stdcall Phidget_setDataRate				(PhidgetHandle phid, double dr);
...
__declspec(dllimport) PhidgetReturnCode __stdcall Phidget_getServerVersion		(PhidgetHandle deviceOrChannel, int *major, int *minor);
__declspec(dllimport) PhidgetReturnCode __stdcall Phidget_getClientVersion		(PhidgetHandle deviceOrChannel, int *major, int *minor);
...
__declspec(dllimport) PhidgetReturnCode __stdcall Phidget_getHubPortSpeed					(PhidgetHandle phid, uint32_t *speed);
__declspec(dllimport) PhidgetReturnCode __stdcall Phidget_setHubPortSpeed					(PhidgetHandle phid, uint32_t speed);
__declspec(dllimport) PhidgetReturnCode __stdcall Phidget_getHubPortSupportsSetSpeed		(PhidgetHandle phid, int *supportsSetSpeed);
__declspec(dllimport) PhidgetReturnCode __stdcall Phidget_getMaxHubPortSpeed				(PhidgetHandle phid, uint32_t *maxSpeed);
__declspec(dllimport) PhidgetReturnCode __stdcall Phidget_getVINTDeviceSupportsSetSpeed	(PhidgetHandle phid, int *supportsSetSpeed);
__declspec(dllimport) PhidgetReturnCode __stdcall Phidget_getMaxVINTDeviceSpeed			(PhidgetHandle phid, uint32_t *maxSpeed);
...
/* Generated by WriteClassHeaderVisitor: Fri Feb 11 2022 14:33:57 GMT-0700 (Mountain Standard Time) */
...
__declspec(dllimport) PhidgetReturnCode __stdcall PhidgetVoltageRatioInput_setDataRate(PhidgetVoltageRatioInputHandle ch,
  double dataRate);
__declspec(dllimport) PhidgetReturnCode __stdcall PhidgetVoltageRatioInput_getDataRate(PhidgetVoltageRatioInputHandle ch,
  double *dataRate);
__declspec(dllimport) PhidgetReturnCode __stdcall PhidgetVoltageRatioInput_getMinDataRate(PhidgetVoltageRatioInputHandle ch,
  double *minDataRate);
__declspec(dllimport) PhidgetReturnCode __stdcall PhidgetVoltageRatioInput_getMaxDataRate(PhidgetVoltageRatioInputHandle ch,
  double *maxDataRate);
...
__declspec(dllimport) PhidgetReturnCode __stdcall PhidgetRCServo_setDataRate(PhidgetRCServoHandle ch, double dataRate);
__declspec(dllimport) PhidgetReturnCode __stdcall PhidgetRCServo_getDataRate(PhidgetRCServoHandle ch, double *dataRate);
__declspec(dllimport) PhidgetReturnCode __stdcall PhidgetRCServo_getMinDataRate(PhidgetRCServoHandle ch, double *minDataRate);
__declspec(dllimport) PhidgetReturnCode __stdcall PhidgetRCServo_getMaxDataRate(PhidgetRCServoHandle ch, double *maxDataRate);
...
__declspec(dllimport) PhidgetReturnCode __stdcall PhidgetAccelerometer_getMaxDataInterval(PhidgetAccelerometerHandle ch,
  uint32_t *maxDataInterval);
__declspec(dllimport) PhidgetReturnCode __stdcall PhidgetAccelerometer_setDataRate(PhidgetAccelerometerHandle ch, double dataRate);
__declspec(dllimport) PhidgetReturnCode __stdcall PhidgetAccelerometer_getDataRate(PhidgetAccelerometerHandle ch, double *dataRate);
__declspec(dllimport) PhidgetReturnCode __stdcall PhidgetAccelerometer_getMinDataRate(PhidgetAccelerometerHandle ch, double *minDataRate);
__declspec(dllimport) PhidgetReturnCode __stdcall PhidgetAccelerometer_getMaxDataRate(PhidgetAccelerometerHandle ch, double *maxDataRate);
__declspec(dllimport) PhidgetReturnCode __stdcall PhidgetAccelerometer_setHeatingEnabled(PhidgetAccelerometerHandle ch,
  int heatingEnabled);
__declspec(dllimport) PhidgetReturnCode __stdcall PhidgetAccelerometer_getHeatingEnabled(PhidgetAccelerometerHandle ch,
  int *heatingEnabled);
...
__declspec(dllimport) PhidgetReturnCode __stdcall PhidgetVoltageInput_getMaxDataInterval(PhidgetVoltageInputHandle ch,
  uint32_t *maxDataInterval);
__declspec(dllimport) PhidgetReturnCode __stdcall PhidgetVoltageInput_setDataRate(PhidgetVoltageInputHandle ch, double dataRate);
__declspec(dllimport) PhidgetReturnCode __stdcall PhidgetVoltageInput_getDataRate(PhidgetVoltageInputHandle ch, double *dataRate);
__declspec(dllimport) PhidgetReturnCode __stdcall PhidgetVoltageInput_getMinDataRate(PhidgetVoltageInputHandle ch, double *minDataRate);
__declspec(dllimport) PhidgetReturnCode __stdcall PhidgetVoltageInput_getMaxDataRate(PhidgetVoltageInputHandle ch, double *maxDataRate);
...
__declspec(dllimport) PhidgetReturnCode __stdcall PhidgetCapacitiveTouch_getMaxDataInterval(PhidgetCapacitiveTouchHandle ch,
  uint32_t *maxDataInterval);
__declspec(dllimport) PhidgetReturnCode __stdcall PhidgetCapacitiveTouch_setDataRate(PhidgetCapacitiveTouchHandle ch, double dataRate);
__declspec(dllimport) PhidgetReturnCode __stdcall PhidgetCapacitiveTouch_getDataRate(PhidgetCapacitiveTouchHandle ch, double *dataRate);
__declspec(dllimport) PhidgetReturnCode __stdcall PhidgetCapacitiveTouch_getMinDataRate(PhidgetCapacitiveTouchHandle ch,
  double *minDataRate);
__declspec(dllimport) PhidgetReturnCode __stdcall PhidgetCapacitiveTouch_getMaxDataRate(PhidgetCapacitiveTouchHandle ch,
  double *maxDataRate);
...
__declspec(dllimport) PhidgetReturnCode __stdcall PhidgetGyroscope_getMaxDataInterval(PhidgetGyroscopeHandle ch,
  uint32_t *maxDataInterval);
__declspec(dllimport) PhidgetReturnCode __stdcall PhidgetGyroscope_setDataRate(PhidgetGyroscopeHandle ch, double dataRate);
__declspec(dllimport) PhidgetReturnCode __stdcall PhidgetGyroscope_getDataRate(PhidgetGyroscopeHandle ch, double *dataRate);
__declspec(dllimport) PhidgetReturnCode __stdcall PhidgetGyroscope_getMinDataRate(PhidgetGyroscopeHandle ch, double *minDataRate);
__declspec(dllimport) PhidgetReturnCode __stdcall PhidgetGyroscope_getMaxDataRate(PhidgetGyroscopeHandle ch, double *maxDataRate);
__declspec(dllimport) PhidgetReturnCode __stdcall PhidgetGyroscope_setHeatingEnabled(PhidgetGyroscopeHandle ch, int heatingEnabled);
__declspec(dllimport) PhidgetReturnCode __stdcall PhidgetGyroscope_getHeatingEnabled(PhidgetGyroscopeHandle ch, int *heatingEnabled);
...
__declspec(dllimport) PhidgetReturnCode __stdcall PhidgetMagnetometer_getMaxDataInterval(PhidgetMagnetometerHandle ch,
  uint32_t *maxDataInterval);
__declspec(dllimport) PhidgetReturnCode __stdcall PhidgetMagnetometer_setDataRate(PhidgetMagnetometerHandle ch, double dataRate);
__declspec(dllimport) PhidgetReturnCode __stdcall PhidgetMagnetometer_getDataRate(PhidgetMagnetometerHandle ch, double *dataRate);
__declspec(dllimport) PhidgetReturnCode __stdcall PhidgetMagnetometer_getMinDataRate(PhidgetMagnetometerHandle ch, double *minDataRate);
__declspec(dllimport) PhidgetReturnCode __stdcall PhidgetMagnetometer_getMaxDataRate(PhidgetMagnetometerHandle ch, double *maxDataRate);
__declspec(dllimport) PhidgetReturnCode __stdcall PhidgetMagnetometer_setHeatingEnabled(PhidgetMagnetometerHandle ch, int heatingEnabled);
__declspec(dllimport) PhidgetReturnCode __stdcall PhidgetMagnetometer_getHeatingEnabled(PhidgetMagnetometerHandle ch,
  int *heatingEnabled);
...
__declspec(dllimport) PhidgetReturnCode __stdcall PhidgetSpatial_setAHRSParameters(PhidgetSpatialHandle ch, double angularVelocityThreshold,
...
__declspec(dllimport) PhidgetReturnCode __stdcall PhidgetSpatial_setDataRate(PhidgetSpatialHandle ch, double dataRate);
__declspec(dllimport) PhidgetReturnCode __stdcall PhidgetSpatial_getDataRate(PhidgetSpatialHandle ch, double *dataRate);
__declspec(dllimport) PhidgetReturnCode __stdcall PhidgetSpatial_getMinDataRate(PhidgetSpatialHandle ch, double *minDataRate);
__declspec(dllimport) PhidgetReturnCode __stdcall PhidgetSpatial_getMaxDataRate(PhidgetSpatialHandle ch, double *maxDataRate);
__declspec(dllimport) PhidgetReturnCode __stdcall PhidgetSpatial_getEulerAngles(PhidgetSpatialHandle ch,
  PhidgetSpatial_SpatialEulerAngles *eulerAngles);
__declspec(dllimport) PhidgetReturnCode __stdcall PhidgetSpatial_setHeatingEnabled(PhidgetSpatialHandle ch, int heatingEnabled);
__declspec(dllimport) PhidgetReturnCode __stdcall PhidgetSpatial_getHeatingEnabled(PhidgetSpatialHandle ch, int *heatingEnabled);
...
__declspec(dllimport) PhidgetReturnCode __stdcall PhidgetSpatial_getQuaternion(PhidgetSpatialHandle ch,
...
__declspec(dllimport) PhidgetReturnCode __stdcall PhidgetTemperatureSensor_getMaxDataInterval(PhidgetTemperatureSensorHandle ch,
  uint32_t *maxDataInterval);
__declspec(dllimport) PhidgetReturnCode __stdcall PhidgetTemperatureSensor_setDataRate(PhidgetTemperatureSensorHandle ch,
  double dataRate);
__declspec(dllimport) PhidgetReturnCode __stdcall PhidgetTemperatureSensor_getDataRate(PhidgetTemperatureSensorHandle ch,
  double *dataRate);
__declspec(dllimport) PhidgetReturnCode __stdcall PhidgetTemperatureSensor_getMinDataRate(PhidgetTemperatureSensorHandle ch,
  double *minDataRate);
__declspec(dllimport) PhidgetReturnCode __stdcall PhidgetTemperatureSensor_getMaxDataRate(PhidgetTemperatureSensorHandle ch,
  double *maxDataRate);
...
__declspec(dllimport) PhidgetReturnCode __stdcall PhidgetEncoder_setDataRate(PhidgetEncoderHandle ch, double dataRate);
__declspec(dllimport) PhidgetReturnCode __stdcall PhidgetEncoder_getDataRate(PhidgetEncoderHandle ch, double *dataRate);
__declspec(dllimport) PhidgetReturnCode __stdcall PhidgetEncoder_getMinDataRate(PhidgetEncoderHandle ch, double *minDataRate);
__declspec(dllimport) PhidgetReturnCode __stdcall PhidgetEncoder_getMaxDataRate(PhidgetEncoderHandle ch, double *maxDataRate);
...
__declspec(dllimport) PhidgetReturnCode __stdcall PhidgetFrequencyCounter_getMaxDataInterval(PhidgetFrequencyCounterHandle ch,
  uint32_t *maxDataInterval);
__declspec(dllimport) PhidgetReturnCode __stdcall PhidgetFrequencyCounter_setDataRate(PhidgetFrequencyCounterHandle ch, double dataRate);
__declspec(dllimport) PhidgetReturnCode __stdcall PhidgetFrequencyCounter_getDataRate(PhidgetFrequencyCounterHandle ch, double *dataRate);
__declspec(dllimport) PhidgetReturnCode __stdcall PhidgetFrequencyCounter_getMinDataRate(PhidgetFrequencyCounterHandle ch,
  double *minDataRate);
__declspec(dllimport) PhidgetReturnCode __stdcall PhidgetFrequencyCounter_getMaxDataRate(PhidgetFrequencyCounterHandle ch,
  double *maxDataRate);
...
__declspec(dllimport) PhidgetReturnCode __stdcall PhidgetPHSensor_setDataRate(PhidgetPHSensorHandle ch, double dataRate);
__declspec(dllimport) PhidgetReturnCode __stdcall PhidgetPHSensor_getDataRate(PhidgetPHSensorHandle ch, double *dataRate);
__declspec(dllimport) PhidgetReturnCode __stdcall PhidgetPHSensor_getMinDataRate(PhidgetPHSensorHandle ch, double *minDataRate);
__declspec(dllimport) PhidgetReturnCode __stdcall PhidgetPHSensor_getMaxDataRate(PhidgetPHSensorHandle ch, double *maxDataRate);
...
__declspec(dllimport) PhidgetReturnCode __stdcall PhidgetDCMotor_setDataRate(PhidgetDCMotorHandle ch, double dataRate);
__declspec(dllimport) PhidgetReturnCode __stdcall PhidgetDCMotor_getDataRate(PhidgetDCMotorHandle ch, double *dataRate);
__declspec(dllimport) PhidgetReturnCode __stdcall PhidgetDCMotor_getMinDataRate(PhidgetDCMotorHandle ch, double *minDataRate);
__declspec(dllimport) PhidgetReturnCode __stdcall PhidgetDCMotor_getMaxDataRate(PhidgetDCMotorHandle ch, double *maxDataRate);
...
__declspec(dllimport) PhidgetReturnCode __stdcall PhidgetCurrentInput_getMaxDataInterval(PhidgetCurrentInputHandle ch,
  uint32_t *maxDataInterval);
__declspec(dllimport) PhidgetReturnCode __stdcall PhidgetCurrentInput_setDataRate(PhidgetCurrentInputHandle ch, double dataRate);
__declspec(dllimport) PhidgetReturnCode __stdcall PhidgetCurrentInput_getDataRate(PhidgetCurrentInputHandle ch, double *dataRate);
__declspec(dllimport) PhidgetReturnCode __stdcall PhidgetCurrentInput_getMinDataRate(PhidgetCurrentInputHandle ch, double *minDataRate);
__declspec(dllimport) PhidgetReturnCode __stdcall PhidgetCurrentInput_getMaxDataRate(PhidgetCurrentInputHandle ch, double *maxDataRate);
...
__declspec(dllimport) PhidgetReturnCode __stdcall PhidgetStepper_setDataRate(PhidgetStepperHandle ch, double dataRate);
__declspec(dllimport) PhidgetReturnCode __stdcall PhidgetStepper_getDataRate(PhidgetStepperHandle ch, double *dataRate);
__declspec(dllimport) PhidgetReturnCode __stdcall PhidgetStepper_getMinDataRate(PhidgetStepperHandle ch, double *minDataRate);
__declspec(dllimport) PhidgetReturnCode __stdcall PhidgetStepper_getMaxDataRate(PhidgetStepperHandle ch, double *maxDataRate);
...
__declspec(dllimport) PhidgetReturnCode __stdcall PhidgetMotorPositionController_getMaxDataInterval(PhidgetMotorPositionControllerHandle ch,
  uint32_t *maxDataInterval);
__declspec(dllimport) PhidgetReturnCode __stdcall PhidgetMotorPositionController_setDataRate(PhidgetMotorPositionControllerHandle ch,
  double dataRate);
__declspec(dllimport) PhidgetReturnCode __stdcall PhidgetMotorPositionController_getDataRate(PhidgetMotorPositionControllerHandle ch,
  double *dataRate);
__declspec(dllimport) PhidgetReturnCode __stdcall PhidgetMotorPositionController_getMinDataRate(PhidgetMotorPositionControllerHandle ch,
  double *minDataRate);
__declspec(dllimport) PhidgetReturnCode __stdcall PhidgetMotorPositionController_getMaxDataRate(PhidgetMotorPositionControllerHandle ch,
  double *maxDataRate);
...
__declspec(dllimport) PhidgetReturnCode __stdcall PhidgetBLDCMotor_getMaxDataInterval(PhidgetBLDCMotorHandle ch,
  uint32_t *maxDataInterval);
__declspec(dllimport) PhidgetReturnCode __stdcall PhidgetBLDCMotor_setDataRate(PhidgetBLDCMotorHandle ch, double dataRate);
__declspec(dllimport) PhidgetReturnCode __stdcall PhidgetBLDCMotor_getDataRate(PhidgetBLDCMotorHandle ch, double *dataRate);
__declspec(dllimport) PhidgetReturnCode __stdcall PhidgetBLDCMotor_getMinDataRate(PhidgetBLDCMotorHandle ch, double *minDataRate);
__declspec(dllimport) PhidgetReturnCode __stdcall PhidgetBLDCMotor_getMaxDataRate(PhidgetBLDCMotorHandle ch, double *maxDataRate);
...
__declspec(dllimport) PhidgetReturnCode __stdcall PhidgetDistanceSensor_getMaxDataInterval(PhidgetDistanceSensorHandle ch,
  uint32_t *maxDataInterval);
__declspec(dllimport) PhidgetReturnCode __stdcall PhidgetDistanceSensor_setDataRate(PhidgetDistanceSensorHandle ch, double dataRate);
__declspec(dllimport) PhidgetReturnCode __stdcall PhidgetDistanceSensor_getDataRate(PhidgetDistanceSensorHandle ch, double *dataRate);
__declspec(dllimport) PhidgetReturnCode __stdcall PhidgetDistanceSensor_getMinDataRate(PhidgetDistanceSensorHandle ch,
  double *minDataRate);
__declspec(dllimport) PhidgetReturnCode __stdcall PhidgetDistanceSensor_getMaxDataRate(PhidgetDistanceSensorHandle ch,
  double *maxDataRate);
...
__declspec(dllimport) PhidgetReturnCode __stdcall PhidgetHumiditySensor_getMaxDataInterval(PhidgetHumiditySensorHandle ch,
  uint32_t *maxDataInterval);
__declspec(dllimport) PhidgetReturnCode __stdcall PhidgetHumiditySensor_setDataRate(PhidgetHumiditySensorHandle ch, double dataRate);
__declspec(dllimport) PhidgetReturnCode __stdcall PhidgetHumiditySensor_getDataRate(PhidgetHumiditySensorHandle ch, double *dataRate);
__declspec(dllimport) PhidgetReturnCode __stdcall PhidgetHumiditySensor_getMinDataRate(PhidgetHumiditySensorHandle ch,
  double *minDataRate);
__declspec(dllimport) PhidgetReturnCode __stdcall PhidgetHumiditySensor_getMaxDataRate(PhidgetHumiditySensorHandle ch,
  double *maxDataRate);
...
__declspec(dllimport) PhidgetReturnCode __stdcall PhidgetLightSensor_getMaxDataInterval(PhidgetLightSensorHandle ch,
  uint32_t *maxDataInterval);
__declspec(dllimport) PhidgetReturnCode __stdcall PhidgetLightSensor_setDataRate(PhidgetLightSensorHandle ch, double dataRate);
__declspec(dllimport) PhidgetReturnCode __stdcall PhidgetLightSensor_getDataRate(PhidgetLightSensorHandle ch, double *dataRate);
__declspec(dllimport) PhidgetReturnCode __stdcall PhidgetLightSensor_getMinDataRate(PhidgetLightSensorHandle ch, double *minDataRate);
__declspec(dllimport) PhidgetReturnCode __stdcall PhidgetLightSensor_getMaxDataRate(PhidgetLightSensorHandle ch, double *maxDataRate);
...
__declspec(dllimport) PhidgetReturnCode __stdcall PhidgetPressureSensor_getMaxDataInterval(PhidgetPressureSensorHandle ch,
  uint32_t *maxDataInterval);
__declspec(dllimport) PhidgetReturnCode __stdcall PhidgetPressureSensor_setDataRate(PhidgetPressureSensorHandle ch, double dataRate);
__declspec(dllimport) PhidgetReturnCode __stdcall PhidgetPressureSensor_getDataRate(PhidgetPressureSensorHandle ch, double *dataRate);
__declspec(dllimport) PhidgetReturnCode __stdcall PhidgetPressureSensor_getMinDataRate(PhidgetPressureSensorHandle ch,
  double *minDataRate);
__declspec(dllimport) PhidgetReturnCode __stdcall PhidgetPressureSensor_getMaxDataRate(PhidgetPressureSensorHandle ch,
  double *maxDataRate);
...
__declspec(dllimport) PhidgetReturnCode __stdcall PhidgetResistanceInput_getMaxDataInterval(PhidgetResistanceInputHandle ch,
  uint32_t *maxDataInterval);
__declspec(dllimport) PhidgetReturnCode __stdcall PhidgetResistanceInput_setDataRate(PhidgetResistanceInputHandle ch, double dataRate);
__declspec(dllimport) PhidgetReturnCode __stdcall PhidgetResistanceInput_getDataRate(PhidgetResistanceInputHandle ch, double *dataRate);
__declspec(dllimport) PhidgetReturnCode __stdcall PhidgetResistanceInput_getMinDataRate(PhidgetResistanceInputHandle ch,
  double *minDataRate);
__declspec(dllimport) PhidgetReturnCode __stdcall PhidgetResistanceInput_getMaxDataRate(PhidgetResistanceInputHandle ch,
  double *maxDataRate);
...
__declspec(dllimport) PhidgetReturnCode __stdcall PhidgetSoundSensor_getMaxDataInterval(PhidgetSoundSensorHandle ch,
  uint32_t *maxDataInterval);
__declspec(dllimport) PhidgetReturnCode __stdcall PhidgetSoundSensor_setDataRate(PhidgetSoundSensorHandle ch, double dataRate);
__declspec(dllimport) PhidgetReturnCode __stdcall PhidgetSoundSensor_getDataRate(PhidgetSoundSensorHandle ch, double *dataRate);
__declspec(dllimport) PhidgetReturnCode __stdcall PhidgetSoundSensor_getMinDataRate(PhidgetSoundSensorHandle ch, double *minDataRate);
__declspec(dllimport) PhidgetReturnCode __stdcall PhidgetSoundSensor_getMaxDataRate(PhidgetSoundSensorHandle ch, double *maxDataRate);
...
__declspec(dllimport) PhidgetReturnCode __stdcall PhidgetHub_getPortPower(PhidgetHubHandle ch, int port, int *state);
